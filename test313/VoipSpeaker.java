...
public class VoipSpeaker implements Runnable {
    private Thread t;
    ...
    public double getFrequency(byte[] array,int sampleSize) {
        double[] audioSamples = new double[array.length / sampleSize];
